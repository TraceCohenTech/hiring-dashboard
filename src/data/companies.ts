...
export const companies: HiringEntry[] = [
  ...
  { company: 'Salesforce', sector: 'Big Tech', previousCount: 72682, currentCount: 77453, netAdded: 4771, growthPercent: 7, aiRelated: true, description: 'Agentforce AI platform; Benioff announced 1,000 new grad/intern hires for Agentforce Apr\'26' },
  ...
  { company: 'Anduril', sector: 'Defense Tech', previousCount: 2400, currentCount: 6200, netAdded: 3800, growthPercent: 158, aiRelated: true, description: 'Arsenal-1 Ohio factory hiring for Roadrunner production; Golden Dome contract win; $1B revenue' },
