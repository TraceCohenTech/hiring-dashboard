...
export const companies: HiringEntry[] = [
  ...
  { company: 'Cloudflare', sector: 'Cybersecurity', previousCount: 5500, currentCount: 4400, netAdded: -1100, growthPercent: -20, aiRelated: true, description: 'Cut 1,100 (20%) May 7, 2026 citing agentic AI era; CEO reported AI usage up 600% in 3 months — pivoting from headcount growth to AI-driven productivity' },
