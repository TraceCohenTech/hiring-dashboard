...
export const companies: HiringEntry[] = [
  ...
  { company: 'Cisco', sector: 'Big Tech', previousCount: 80000, currentCount: 76000, netAdded: -4000, growthPercent: -5, aiRelated: true, description: 'Cut 4,000 jobs (5%) May 2026 on same day as record $15.8B revenue; $5.3B AI orders from hyperscalers; third major restructuring in two years' },
  ...
  { company: 'Freshworks', sector: 'SaaS/Enterprise', previousCount: 4500, currentCount: 4000, netAdded: -500, growthPercent: -11, aiRelated: true, description: 'Cut 500 (11%) May 2026; CEO Woodside: "over half of code written by AI"; $228.6M Q1 revenue (+16% YoY); second AI-driven cut since Nov 2024' },
  { company: 'Intuit', sector: 'SaaS/Enterprise', previousCount: 18200, currentCount: 15200, netAdded: -3000, growthPercent: -16, aiRelated: true, description: 'Cut 3,000 (17%) on May 20, 2026 to fund multi-year AI deals with Anthropic and OpenAI; embeds Claude/ChatGPT into TurboTax, QuickBooks, Credit Karma, and Mailchimp; raised FY2026 revenue guidance to $21.34B+' },
  ...
  { company: 'Coinbase', sector: 'Fintech', previousCount: 4700, currentCount: 4000, netAdded: -700, growthPercent: -15, aiRelated: true, description: 'Cut 700 jobs (14%) May 2026 in AI-native restructuring; CEO Armstrong building one-person teams and "fleets of agents"' },
  ...
  // ============================================================
  { company: 'Accenture', sector: 'Consulting', previousCount: 733000, currentCount: 786432, netAdded: 53432, growthPercent: 7, aiRelated: true, description: 'Added 7,000+ in H1 FY2026; 786K total; 85K+ AI professionals (exceeded 80K target ahead of schedule); $3B AI investment' },
