...
export const companies: HiringEntry[] = [
  ...
  { company: 'Sierra', sector: 'AI-Native', previousCount: 300, currentCount: 749, netAdded: 449, growthPercent: 150, aiRelated: true, description: 'Bret Taylor\'s enterprise AI agent company; $950M raised at $15.8B valuation May 2026; 40%+ of Fortune 50 as customers; billions of agent interactions' },

  // ============================================================
  // Big Tech (22 companies)
  // ============================================================
  ...
  { company: 'Meta', sector: 'Big Tech', previousCount: 74000, currentCount: 66000, netAdded: -8000, growthPercent: -11, aiRelated: true, description: 'Executed 8,000 (10%) cuts on May 20, 2026; cancelled 6,000 open roles; redirected 7,000 workers into AI pods; Zuckerberg betting $115–$135B on AI capex' },
  ...
  { company: 'LinkedIn', sector: 'Big Tech', previousCount: 17500, currentCount: 16625, netAdded: -875, growthPercent: -5, aiRelated: false, description: 'Cut 875 jobs (5%) May 2026 despite record $5B+ quarterly revenue; efficiency restructuring; AI not cited as reason; Graz office closed' },
  { company: 'Cisco', sector: 'Big Tech', previousCount: 85000, currentCount: 81000, netAdded: -4000, growthPercent: -5, aiRelated: true, description: 'Cut 4,000 jobs (5%) May 2026 on same day as record $15.8B revenue; $5.3B AI orders from hyperscalers; third major restructuring in two years' },

  // ============================================================
  // Defense Tech (13 companies)
  // ============================================================
  ...
  { company: 'True Anomaly', sector: 'Defense Tech', previousCount: 100, currentCount: 250, netAdded: 150, growthPercent: 150, aiRelated: true, description: 'Space defense startup; $650M Series D at $2.2B valuation Apr 2026; targeting 500+ employees by year-end; Golden Dome interceptor program' },
  ...
  { company: 'Cloudflare', sector: 'Cybersecurity', previousCount: 5500, currentCount: 4400, netAdded: -1100, growthPercent: -20, aiRelated: true, description: 'Cut 1,100 jobs (20%) May 2026; CEO Prince: "AI usage up 600% in 3 months"; pivoting to agentic AI infrastructure; first layoff in 16-year history' },
  ...
  { company: 'SentinelOne', sector: 'Cybersecurity', previousCount: 2800, currentCount: 2570, netAdded: -230, growthPercent: -8, aiRelated: true, description: 'Cut 8% (230 jobs) May 28, 2026 to fund AI security growth; 21% revenue growth; ARR $1.16B; CEO: "deliberate evolution to raise the performance bar"' },
  ...
  { company: 'Freshworks', sector: 'SaaS/Enterprise', previousCount: 4500, currentCount: 4000, netAdded: -500, growthPercent: -11, aiRelated: true, description: 'Cut 500 (11%) May 2026; CEO: "over half of code written by AI"; $228.6M Q1 revenue (+16% YoY); second AI-driven cut since Nov 2024' },
  { company: 'Intuit', sector: 'SaaS/Enterprise', previousCount: 18200, currentCount: 15200, netAdded: -3000, growthPercent: -16, aiRelated: true, description: 'Cut 3,000 (17%) May 2026; signed multi-year AI deals with Anthropic and OpenAI; embedding Claude/GPT into TurboTax, QuickBooks, Credit Karma, Mailchimp' },
  { company: 'Wix', sector: 'SaaS/Enterprise', previousCount: 5277, currentCount: 4222, netAdded: -1055, growthPercent: -20, aiRelated: true, description: 'Cut ~1,000 (20%) May 28, 2026; CEO cites AI transformation and currency headwinds; rebuilding around AI-native roles' },
  { company: 'Webflow', sector: 'SaaS/Enterprise', previousCount: 1740, currentCount: 1392, netAdded: -348, growthPercent: -20, aiRelated: true, description: 'Cut ~20% of workforce May 27, 2026; CEO Linda Tong: AI transformed web development; restructuring for "agentic web" era; employees locked out without advance notice' },

  // ============================================================
  // Fintech (7 companies)
  // ============================================================
  { company: 'Block (Square)', sector: 'Fintech', previousCount: 10000, currentCount: 6000, netAdded: -4000, growthPercent: -40, aiRelated: true, description: 'Cut ~4,000 (40%) early 2026; Jack Dorsey: AI enables operating with fewer; restructuring Square + Cash App for AI era' },
  { company: 'Coinbase', sector: 'Fintech', previousCount: 4700, currentCount: 4000, netAdded: -700, growthPercent: -15, aiRelated: true, description: 'Cut 700 jobs (15%) May 2026 in AI-native restructuring; CEO Armstrong building one-person teams directing fleets of agents' },
  ...
  { company: 'PayPal', sector: 'Fintech', previousCount: 23800, currentCount: 19040, netAdded: -4760, growthPercent: -20, aiRelated: true, description: 'Plans 4,760 cuts (20%) over 2-3 years under CEO Alex Chriss; $1.5B run-rate savings target; "becoming a technology company again through AI"' },
  ...
  { company: 'Waymo', sector: 'Robotics', previousCount: 1200, currentCount: 2500, netAdded: 1300, growthPercent: 108, aiRelated: true, description: '$16B raised at $126B valuation Feb 2026; expanded to 1,400+ sq miles across 11 US cities May 2026; $350M+ ARR; 15M trips in 2025' },
  ...
  { company: 'Crusoe Energy', sector: 'Energy', previousCount: 200, currentCount: 1395, netAdded: 1195, growthPercent: 598, aiRelated: true, description: 'AI factory company; $1.375B Series E at $10B valuation; ~1,395 employees; 45+ GW power pipeline; projects $2B+ revenue in 2026' },

  // ============================================================
  // Consulting (1 company)
  // ============================================================
  { company: 'Accenture', sector: 'Consulting', previousCount: 733000, currentCount: 786432, netAdded: 53432, growthPercent: 7, aiRelated: true, description: '786K total employees; 85K+ AI professionals — exceeded 80K target ahead of schedule; $3B AI investment; adding 7,000+ in H1 FY2026' },
